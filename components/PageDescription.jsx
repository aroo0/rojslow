...
const PageDescription = () => {
  return (
    <div className=' z-20 flex xl:relative flex-col py-6 px-4 sm:px-10 2xl:px-16 font-andada gap-8 leading-8 mb-16 h-full'>

        <div className='border_left'>
       </div>
        <h2>
            <span className='sm:text-lg tracking-wide'>czym są </span>
            <span className='sm:text-xl 2xl:text-2xl tracking-widest font-extrabold underline underline-offset-8 decoration-2 '>Rzeczowniki zbiorowe?</span>
        </h2>

        <p className='bg-white/10 p-3 text-sm mt-4 '>«rzeczownik oznaczający zbiór przedmiotów jednostkowych, np. tłum, las» (PWN)</p>
        ...
        <p>Rzeczowniki zbiorowe są rzeczownikami w liczbie pojedynczej, które opisują zbiór lub grupę innych rzeczowników. Mówimy na przykład <i>"Zespół przygotowuje się do gry"</i> zamiast <i>"Zawodnicy przygotowują się do gry"</i>, podkreślając tym samym jedność zespołu.</p>
        
        <p>W języku polskim są one jednak stosunkowo rzadkie. Podczas gdy angielski może pochwalić całym ich wachlarzem, język polski ma ich znacznie mniej i są one zdecydowanie bardziej ogólne.</p>

        <div className='xl:sticky top-[-8rem] flex flex-col gap-10'>
